...
public class TypeConvert {
	...
	// // String ss = "GD测试消息格式为3的下行消息2010-03-24。";
	// // String s = new String(ss.getBytes(),"UTF-8");
	//
	// // String hexStr = byteArrayToHexString(s.getBytes());
	// // System.out.println("hexStr = " + hexStr);
	//
	// String s = "application/vnd.wap.mms-message";
	// System.out.println(byteArrayToHexString(s.getBytes()));
	//	}
